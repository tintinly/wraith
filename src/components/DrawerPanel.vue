<template>
  <Teleport to="body">
    ...
    <Transition name="drawer-panel">
      <div
        v-if="isOpen"
        class="absolute left-1/2 translate-x-[-50%] h-[65vh] max-h-250 max-w-content flex flex-col rounded-xl border border-border backdrop-blur-2xl  shadow-xl shadow-border z-50

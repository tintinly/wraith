    ...
    <div class="flex items-center justify-between">
        <button
            class="absolute top-[5%] right-[5%] rounded-full outline-outline p-2 inline-flex cursor-pointer
                   hover:outline transition-all duration-300"
            title="切换明暗模式"
        ...
        >
            ...
            <!-- 当前为亮色模式时显示月亮图标（点击切换暗色） -->
            <span v-else-if="themePreference === 'dark'" class="icon-[mynaui--moon] text-slate-600"></span>
            <!-- 跟随系统主题 -->
             <span v-else class="icon-[mynaui--circle-half-circle-solid] text-gray-600"></span>
        </button>
    </div>
</template>
